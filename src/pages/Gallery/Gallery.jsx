...
const Gallery = () => {
  return (
    ...
    <div>
        ...
        <p className="gineses-text">Mirá nuestra carta y tentate con nuestra propuesta de chocolate con churros y porras. Y si estas con ganas de algo salado tenemos ensaladas, bocatas, tostados y más. Descubrilos!</p>      
        <div className='Container-gallery'>
            <img src={img1} alt="Bocata de jamón, churros, chocolate y café con leche"/>
            <img src={img2} alt="Arte latte"/>
            <img src={img3} alt="Ensalada vegetariana, ensalada de pollo y ensalada de atún"/>
